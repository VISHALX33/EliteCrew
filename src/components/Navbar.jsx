        ...
        <li>
          ...
          <li>
            <Link 
              ...
              className="bg-amber-400 text-black  text-xl px-6 py-3 rounded-lg font-semibold hover:from-purple-600 hover:via-pink-600 hover:to-red-600 transition-all duration-300 transform hover:scale-105"
            >
              Get Started
            </Link>
          </li>
        ...
        <div className="md:hidden mt-4">
          ...
          <li>
            ...
            <Link 
              to="/signup-login" 
              onClick={handleGetStarted} 
              className="bg-amber-400 text-black text-xl  px-4 py-2 rounded-lg font-semibold hover:from-purple-600 hover:via-pink-600 hover:to-red-600 transition-all duration-300 transform hover:scale-105"
            >
              Get Started
            </Link>
          </li>
